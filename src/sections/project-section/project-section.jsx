...
import lessonPlanImg from "../../assets/Projects/lesson-plan-builder.png";
  ...
  return (
    <div className="project-section-container">
      <div className="project-header-container mb-15">
        <p className="project-header-text font-bold tracking-widest text-2xl">
          Projects
        </p>
      </div>
      ...
      <div className="project-list-container flex flex-col items-center gap-4">
        <div className="project-item grid grid-cols-4 gap-x-5 h-fit">
          ...
          <div className="project-details-container flex flex-col col-span-3 gap-3">
            <div className="project-title-container flex flex-col items-start">
              ...
              <p className="position-text text-sm opacity-50">
                {" "}
                - Main Developer
              </p>
            </div>
            ...
            <div className="project-info-container">
              <p className="project-info text-sm opacity-50 text-justify">
                Enhances CBCH's operational efficiency and community engagement
                by transitioning from paper-based methods to a centralized
                digital system, improving accessibility, data security, and
            ...
            <div className="technologies-container flex flex-row flex-wrap gap-2">
              <div className="technology-items opacity-50 bg-[var(--highlight-color)] pl-4 pr-4 pt-1 pb-1 rounded-3xl">
                <p className="technology-name text-sm text-[var(--text-highlight)]">
                  React
                </p>
              </div>
              <div className="technology-items opacity-50 bg-[var(--highlight-color)] pl-4 pr-4 pt-1 pb-1 rounded-3xl">
        ...
        <div className="project-item grid grid-cols-4 gap-x-5 h-fit">
          ...
          <div className="project-details-container flex flex-col col-span-3 gap-3">
            ...
            <div className="project-info-container">
              <p className="project-info text-sm opacity-50 text-justify">
                A personal productivity web app that lets users manage tasks
                with features like user authentication, task creation, editing,
                and completion tracking. Built with a modern tech stack for a
        ...
        <div className="project-item grid grid-cols-4 gap-x-5 h-fit">
          ...
          <div className="project-details-container flex flex-col col-span-3 gap-3">
            ...
            <div className="project-info-container">
              <p className="project-info text-sm opacity-50 text-justify">
                Freelance Flow is a full-stack productivity web app built with
                the MERN stack, tailored specifically for freelancers. It
                centralizes essential tools like task tracking, time management,
                client management, invoicing, and budgeting into a single,
                intuitive dashboard.
              </p>
            </div>
        ...
        <div className="project-item grid grid-cols-4 gap-x-5 h-fit">
          ...
          <div className="project-details-container flex flex-col col-span-3 gap-3">
            ...
            <div className="project-info-container">
              <p className="project-info text-sm opacity-50 text-justify">
                AcademIQ is a lesson planning platform created to support
                teachers in organizing objectives, procedures, and resources
                without friction. With secure storage and flexible templates,
                your focus stays where it belongs, on teaching.
              </p>
            </div>
            ...
            <div className="code-live-container flex flex-row gap-5 items-center">
              <div className="visit-code-container flex flex-row items-center gap-1">
                <a
                  href="https://github.com/DevJaem31/lesson-plan-builder"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-1 text-sm link-code"
                >
